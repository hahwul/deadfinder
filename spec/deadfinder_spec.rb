  ...
  describe '#gen_output' do
    ...
    context "when output is empty" do
      ...
      it 'does nothing if output file is not specified' do
        options['output'] = ''
        # gen_output should return immediately without writing a file
        expect { gen_output(options) }.not_to raise_error
      end
    end
  end

  describe 'DeadFinderRunner#default_options' do
    it 'provides a default options hash with expected keys' do
      runner = DeadFinderRunner.new
