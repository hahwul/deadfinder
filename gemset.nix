{
  ...
  cyclonedx-ruby = {
    dependencies = ["json" "nokogiri" "ostruct" "rest-client"];
    groups = ["development" "test"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "003901mnaj16zblhj9w2iq3gs8i42nzfr4k0lvvq3n7v4ilfxlm6";
      type = "gem";
    };
    version = "1.1.0";
  };
  ...
  panolint = {
    dependencies = ["brakeman" "rubocop" "rubocop-performance" "rubocop-rails" "rubocop-rake" "rubocop-rspec"];
    groups = ["development" "test"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "119briqhq3hgzcacmr2w1iw36svjnk8x06r4sb86ng4w91nccnzj";
      type = "gem";
    };
    version = "0.1.6";
  };
  ...
  rubocop-rspec_rails = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1r489726zdxmh44lqpdh6fh6nnzv63950kp1idnrnnnax6xmmsaa";
      type = "gem";
    };
    version = "2.29.1";
  };
